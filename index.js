...
function sendMessage() {
    ...
    // if message = developer - show our message
        ...
        setTimeout(() => {
            ...
            appendMessage('bot', 'i was coded by sai mahendra bejawada \nGITHUB : @sunstromium');
...
function appendMessage(sender, message) {
    ...
    buttonIcon.classList.remove('fa-solid', 'fa-square-arrow-up-right');
    ...
    if (sender === 'user') {
        ...
        icon.classList.add('fa-solid', 'fa-shapes');
